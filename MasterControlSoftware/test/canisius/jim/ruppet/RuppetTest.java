...
class RuppetTest {
    ...
    // Since we are only testing static methods and getters, the we only need to construct a Ruppet object once to test.
    ...
    @Test
    void muteAllTracks() {
        // Muting all Tracks should cause all of the Ruppet's Tracks to be muted.
        ...
        // Muting all Tracks except for the Ruppet's Heart Track should cause all of the Ruppet's Tracks to be muted
